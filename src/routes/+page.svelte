		...
		<div class="w-full max-w-xl mx-auto px-6">
			...
			<div class="text-2xl md:text-3xl sm:text-5xl lg:text-7xl font-semibold text-neutral-300 mt-5">Blood Glucose</div>
				<div class="p-6 bg-neutral-800 rounded mt-2">
					...
					<div class="">
						<div class="text-xl md:text-3xl font-semibold">Alarms</div>

						<div class="flex gap-2 text-xl md:text-3xl">
							<div class="text-neutral-100 font-thin">High: {data.patientName.data[0].targetHigh}</div>
							<div class="text-neutral-100 font-thin">Low: {data.patientName.data[0].targetLow}</div>
						</div>
					</div>


					<div class="mt-5">
						<div class="text-lg md:text-3xl font-semibold">Ranges</div>
			...
			<div class="w-full flex flex-col items-center justify-center gap-2 my-5">
				<a href="javascript:void(0)" on:click={refreshPage} class="border border-teal-500 md:hover:border-teal-400 text-teal-500 hover:text-teal-400 transition-all duration-200 text-neutral-900 py-4 px-6 rounded w-full font-bold uppercase flex justify-center">Refresh</a>
